...
import { reactive, onMounted, ref, nextTick, onBeforeMount} from 'vue'
...
const grid = reactive<Letter[][]>(new Array(16).fill(new Array(25).fill({isRendered: false, isAnimated: false})))
